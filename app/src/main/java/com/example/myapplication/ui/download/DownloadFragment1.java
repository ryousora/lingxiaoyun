...
//    @BindView(R.id.download_list)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        download_list= root.findViewById(R.id.download_list);
        download_list.setLayoutManager(new LinearLayoutManager(this.getContext()));
        download_list.setAdapter(adapter = new TaskItemAdapter());

        TasksManager.getImpl().onCreate(new WeakReference<DownloadFragment1>(this));
        return root;
    }
...
/**
        ...
        public void updateDownloading(final int status, final long sofar, final long total) {
            ...
            switch (status) {
                ...
                case FileDownloadStatus.progress:
                    ...
                    break;
                default:
                    taskStatusTv.setText("DemoApplication.CONTEXT.getString(R.string.tasks_manager_demo_status_downloading, status)");
                    break;
            }
    ...
    public static class TasksManager {
        ...
        private void registerServiceConnectionListener(final WeakReference<DownloadFragment1>
        ...
        public void onCreate(final WeakReference<DownloadFragment1> activityWeakReference) {
...
/**
    ...
    private static class TasksManagerDBController {
        ...
        private TasksManagerDBController() {
            TasksManagerDBOpenHelper openHelper = new TasksManagerDBOpenHelper(DownloadFragment1.CONTEXT);
        ...
        public TasksManagerModel addTask(final String url, final String path) {
            ...
            TasksManagerModel model = new TasksManagerModel();
            model.setId(id);
            model.setName(DownloadFragment1.CONTEXT.getString(R.string.tasks_manager_demo_name, id));
            model.setUrl(url);
            model.setPath(path);
